...
class Websocket(Response):  # pylint: disable=too-few-public-methods
    ...
    **It is very important to close the connection manually, it will not be done automatically.**
    ...
    def __init__(  # pylint: disable=too-many-arguments
        ...
        self._headers.setdefault("Compression", None)
        ...
        self.maxheader = buffer_size/2
        self.maxpayload = buffer_size-5
        self.state = HEADERB1
    ...
    def _handlePacket(self):
        ...
        if self.opcode == CLOSE:
            ...
            if self.opcode == STREAM:
                ...
                self.send_message(self.data, Websocket.PONG)
    ...
    def _read_frame(self):
        ...
        loaded_len = self._request.connection.recv_into(buffer, 16384)

        for indx in range (0, loaded_len):
            self._parseMessage(buffer[indx])
